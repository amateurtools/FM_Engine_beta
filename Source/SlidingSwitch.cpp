...
// old method draws triangles using the path method that forces windows direct2d which is bad for yabridge
...
//     // Draw triangle indicator centered on knob (outline version)
//     float triangleBaseWidth = 10.0f;
//     float triangleHeight = 6.0f;
//     float centerX = knobX + knobSize / 2.0f;
//     float centerY = knobY + knobSize / 2.0f;
...
//     g.setColour(juce::Colour::fromRGB(160, 160, 160));
//     g.drawLine(point1.x, point1.y, point2.x, point2.y, 1.5f);
//     g.drawLine(point2.x, point2.y, point3.x, point3.y, 1.5f);
//     g.drawLine(point3.x, point3.y, point1.x, point1.y, 1.5f);
// }
