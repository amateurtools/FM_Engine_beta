...
private:
    ...
    SidewaysToggleSwitch outputClipToggle; // invert
    ...
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> outputClipAttachment;
