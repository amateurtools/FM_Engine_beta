...
private:
    ...
    juce::AudioParameterBool* outputClipParam = nullptr;
    juce::AudioParameterBool* oversamplingParam = nullptr;
    juce::AudioParameterBool* pdcParam = nullptr;
    ...
    float newBaseDelay = 0.0f;  // relevant to PDC coordinating
    float lastBaseDelay = 0.0f; // relevant to PDC coordinating
